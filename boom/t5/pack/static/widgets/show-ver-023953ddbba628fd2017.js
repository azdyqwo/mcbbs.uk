...
STK.register("common.widget.log", function($) {
    ...
    return function(opts) {
        ...
        var src = "../r-uid-.gif" + uid + "&appid=" + appid + "&refer=" + refer + "&cat=" + cat + "&step=" + conf["step"] + "&rnd=" + +(new Date);
        var img = new Image;
        img.src = src;
        img = null;
    };
...
STK.register("common.widget.login", function($) {
    ...
    return function(opts) {
        ...
        that.showLogin = function() {
            ...
            if (is360 || isWeixin) {
                location.href = protocol + "https://service.weibo.com/reg/loginindex.php?regbackurl=http%3A%2F%2Fweibo.com&backurl=" + encodeURIComponent(location.href) + params + "&rnd=" + +(new Date).valueOf();
                return;
            }
            var weiboURL = protocol + "https://service.weibo.com/reg/loginindex.php?regbackurl=http%3A%2F%2Fweibo.com&backurl=http%3A%2F%2F" + location.host + "%2Fstaticjs%2FloginProxy.html" + params + "&rnd=" + +(new Date).valueOf();
...
STK.register("common.widget.reg", function($) {
    ...
    var tip = $.ui.tipAlert({
        ...
        template: '<#et temp data><div class="tips_inner">' + '<span class="WB_tipS_warn"></span><span class="WB_icon_txt">' + $L("#L{您的帐号尚未开通微博，}") + "<a href=" + protocol + '"https://weibo.com/signup/full_info.php?appsrc=6cm7D0&backurl=' + encodeURIComponent(document.URL) + '&showlogo=0&vsrc=weiboshow&from=zw" target="_blank">' + $L("#L{立即开通}") + "</a></span>" + "</#et>"
    });
